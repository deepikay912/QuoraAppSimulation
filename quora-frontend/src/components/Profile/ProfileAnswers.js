   ...
   <img  style = {{ width : 142, height : 142, marginleft : 100}}src={this.state.profilepic}
      ...
      save
             ...
             <div className = 'col-sm-8' >
              <h3 style = {{marginTop : 30}}> <b>{this.state.Name}  </b> {(this.state.Email === localStorage.getItem('email')) ? <button onClick = {this.editProfile}> <i class="fas fa-pen"></i>  </button>  : <button value = {this.state.Email} onClick = {this.followUser}> Follow  </button> }   </h3> 
