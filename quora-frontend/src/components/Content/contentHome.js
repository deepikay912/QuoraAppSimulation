...
return (
    ...
    this.state.filteredContent.map(content => {
     if(content.action == 'question') {
        return(
            <div >
            <Link class ="questionLink" to ={{pathname : "/answers",state :{'questionid':content.question[0]._id}}} >   {content.question[0].Question}</Link>
        ...
        return(
            <div >
            <Link class ="questionLink" to ={{pathname : "/answers",state :{'questionid':content.question[0]._id}}}> Your Answer to {content.question[0].Question}</Link>
